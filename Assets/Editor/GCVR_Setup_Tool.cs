...
public class GCVR_Setup_Tool : EditorWindow
{
    ...
    {
        request = Client.Add("https://github.com/googlevr/cardboard-xr-plugin.git#v1.30.1");
    ...
    static void OpenPackageManagerSamples()
    {
        ...
        /*EditorUtility.DisplayDialog(
            "Cardboard Samples",
            "Откройте в Package Manager пакет «Google Cardboard XR Plugin» и нажмите «Import» во вкладке Samples.",
            "Ок"
        );*/
    }
